...
num > num2 ? alert(`${num1} is Max`):alert(`${num2} is Max`);
...
switch(true) {
  case salary <= 20000:
  alert(`Your in-hand is ${(salary - (salary/100)*10)}`);
  break;
  case salary <= 40000:
  alert(`Your in-hand is ${(salary - (salary/100)*20)}`);
  break;
  case salary <= 50000:
  alert(`Your in-hand is ${(salary - (salary/100)*30)}`);
  default: 
...
*/
let weather = prompt(`Hey, how is the weather outsie?`);
if(weather === "sunny"){
